       ...
       <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 user-menu-bar" >
       	   ...
       	   <com:TPanel ID="user_menu_login" CssClass="top-bar-menu pull-right" Visible='false'>
      	   		<ul class="nav nav-pills" role="tablist">
      	   			...
      	   			<li><a href="/backend/3rdparty.html" title="3rd Party Import"><i class="glyphicon glyphicon-th-list"></i><span class="hidden-xs hidden-sm"> 3rd Party Import</span></a></li>
